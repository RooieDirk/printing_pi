...
PrintingBase::PrintingBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
  ...
  m_textCtrlRudderStbd->SetToolTip( _("Rudder Starboard") );
	...
	this->Connect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( PrintingBase::OnDLeftClick ) );
...
PrintingBase::~PrintingBase()
{
	...
	this->Disconnect( wxEVT_LEFT_DCLICK, wxMouseEventHandler( PrintingBase::OnDLeftClick ) );
